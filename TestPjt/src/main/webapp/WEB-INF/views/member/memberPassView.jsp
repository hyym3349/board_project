                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user"  method="post" id="passForm" action="/member/memberPass">
                                    <div style="text-align:center;" class="form-group">
                                        <label   class="control-label" for="userPass">변경할 비밀번호를 입력해주세요!</label>
             					...
             					<button class="btn btn-google btn-user btn-block" id="" type="submit">비밀번호수정</button>
                                <input type="button" value="취소" class="btn btn-primary btn-user btn-block" id="goHomeBtn"/>
