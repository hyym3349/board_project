                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
								...
								<div class="form-group">
								<button class="btn btn-info btn-user btn-block" id="memberPassBtn" type="button">비밀번호변경</button>
								</div>
								<div class="form-group">
								<button class="btn btn-primary btn-user btn-block" id="homeBtn" type="button">홈</button>
								</div>
								</form>
										<div>
