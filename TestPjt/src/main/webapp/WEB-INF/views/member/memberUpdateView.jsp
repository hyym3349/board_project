...
<title>Board_memberUpdate</title>
				...
				<div class="row">
					...
					<div class="col-lg-7">
						<div class="p-5">
							...
							<form class="user" id="updateForm" action="/member/memberUpdate"
								method="post">
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<label class="control-label" for="Password">비밀번호</label> <input
											...
											maxlength="20" id="userPass" name="userPass"
											placeholder="Password">
									</div>
									<div class="col-sm-6">
										<label class="control-label" for="userPass2">비밀번호 확인</label> <input
											type="password" class="form-control form-control-user"
											maxlength="20" id="userPass2" name="userPass2"
											onchange="passchk()" placeholder="Repeat Password">
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<label class="control-label" for="userName">이름</label> <input
											type="text" class="form-control form-control-user"
											maxlength="12" id="userName" name="userName"
											placeholder="Name" value="${member.userName}">
									</div>
									<div class="col-sm-6">
										<label class="control-label" for="userNick">닉네임</label> <input
											type="text" class="form-control form-control-user"
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<label class="control-label" for="userTell">전화번호</label> <input
											type="text" class="form-control form-control-user"
											maxlength="13" id="userTell" name="userTell"
											placeholder="Tell" value="${member.userTell}">
									</div>
									<div class="col-sm-6">
										<label class="control-label" for="userBirth">생년월일</label> <input
											type="text" class="form-control form-control-user"
								...
								<div class="form-group">
									<label class="control-label" for="userEmail">이메일</label> <input
										...
										maxlength="20" id="userEmail" name="userEmail"
							...
							<form class="user">
								<button class="btn btn-primary btn-user btn-block" type="button"
									id="submit">회원정보수정</button>

								<hr>
								<a href="/home" class="btn btn-google btn-user btn-block"> <i
									class="fab  fa-fw"></i> 취소
								</a> <a href="/board/list"
									class="btn btn-facebook btn-user btn-block"> <i
									class="fab -f fa-fw"></i> 게시판
								</a>
