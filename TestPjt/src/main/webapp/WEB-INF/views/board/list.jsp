					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<a style="text-decoration: none;"
								class="m-0 font-weight-bold text-primary">Board list</a>
						</div>
						...
						<div>
							<div class="card-body">
								<div class="table-responsive">
									...
									<input style="width: 90px; height: 35px;" type="button"
										value="선택삭제" class="btn btn-outline-primary"
										onclick="deleteValue();">
									...
									<div class="search" style="float: right;">
										<span
											...
											<select style="width: 110px; height: 35px; cursor: pointer;"
											class="form-control navbar-left list-group "
											name="searchType">
												<option value="n"
												...
												<option value="tw"
													<c:out value="${scri.searchType eq 'tc' ? 'selected' : ''}"/>>제목+작성자</option>
										</select> <script>
							...
							function enterkey() {
   						    ...
   						    self.location = "list" + '${pageMaker.makeQuery(1)}' + "&searchType=" + $("select option:selected").val() + "&keyword=" + encodeURIComponent($('#keywordInput').val());
											...
											style="display: inline-block; width: 200px; height: 36px;">
											<input class="form-control navbar-left list-group"
											style="width: 200px; height: 36px;" type="search"
											placeholder="검색하기..." name="keyword" id="keywordInput"
											onkeyup="enterkey()" value="${scri.keyword}" />
										</span> <span
											style="display: inline-block; width: 62px; height: 36px;">
											<button style="width: 60px; height: 34px;" id="searchBtn"
												type="button" class="btn btn-outline-primary">검색</button>
										</span>
						      ...
						      $(function(){
						        $('#searchBtn').click(function() {
						          self.location = "list" + '${pageMaker.makeQuery(1)}' + "&searchType=" + $("select option:selected").val() + "&keyword=" + encodeURIComponent($('#keywordInput').val());
										...
										<thead>
											...
											<tr>
												...
												<th style="text-align: center; width: 5%;"><input
													style="cursor: pointer;" id="allCheck" type="checkbox"
													name="allCheck" /></th>
																...
																<tr>
																	<c:if test="${list.userName == member.userName}">
																		<td style="text-align: center;"><input
																			style="cursor: pointer;" name="RowCheck"
																			type="checkbox" value="${list.bno}" /></td>
																	</c:if>
																	<c:if test="${list.userName != member.userName}">
																		<td style="text-align: center;"><input
									...
									<div style="display: inline-block; float: right;">
										<a href="/board/writeView"><input type="button"
											value="글 작성" class="btn btn-outline-primary"></a>
									</div>
								...
								<div class="paging">
									...
									<c:forEach begin="${pageMaker.startPage}"
										...
										<li><a
											style="${pageMaker.cri.page == idx ? 'color:white; background:#4e73df;' : '' }"
											class="select" href="list${pageMaker.makeSearch(idx)}">${idx}</a></li>
									</c:forEach>

									<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
										<li><a class="select pag"
