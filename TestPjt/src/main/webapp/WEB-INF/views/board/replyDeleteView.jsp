								...
								<div class="p-5">
									...
									<form name="updateForm" role="form" method="post"
										...
										<input type="hidden" name="bno" value="${replyDelete.bno}"
											...
											name="rno" value="${replyDelete.rno}" /> <input
										...
										<div class="form-group">
											...
											<textarea readonly="readonly"
												style="border: 1px solid; padding: 10px; border-radius: 10px; background-color: #eaecf4; border-color: #d1d3e2"
												name="content" id="content" rows="10" cols="36"><c:out
													value="${replyDelete.content}" /></textarea>
										</div>

										<div>
											<p style="font-weight: 900;">정말 삭제 하시겠습니까?</p>
											<button type="submit"
												class="delete_btn btn btn-outline-primary">삭제하기</button>
											<button type="button"
												class="cancel_btn btn btn-outline-primary">취소하기</button>
										</div>
									</form>
								</div>
							</div>
