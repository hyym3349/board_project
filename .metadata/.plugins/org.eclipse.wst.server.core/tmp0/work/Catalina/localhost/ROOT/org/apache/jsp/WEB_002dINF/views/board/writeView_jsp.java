 ...
 * Generated at: 2021-08-09 08:42:39 UTC
...
response.setHeader("Cache-Control", "no-cache");
      ...
      out.write("					\"<div><input type='file' id='file_\" + (fileIndex) + \"' style='cursor: pointer; color:#4e73df;' name='file_\" + (fileIndex) + \"'>\" + \"</button>\"\n");
      out.write("							+ \"<button type='button' style='cursor: pointer; color:#4e73df;' id='fileDelBtn' class='btn btn-outline-error'>\" + \"&nbsp삭제\" + \"</button> </div>\"\n");
      out.write("				);\n");
      out.write("			});\n");
      out.write("			\n");
