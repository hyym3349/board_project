 ...
 * Generated at: 2021-08-03 00:41:29 UTC
...
response.setHeader("Cache-Control", "no-cache");
      ...
      out.write("			$(\"#fileIndex\").append(\"<div><input type='file' style='cursor: pointer; color:#4e73df;' name='file_\"+(fileIndex++)+\"'>\"+\"</button>\"+\"<button type='button' style='cursor: pointer; color:#4e73df;' id='fileDelBtn' class='btn btn-outline-error'>\"+\"&nbsp삭제\"+\"</button></div>\");\n");
      out.write("		});\n");
    ...
    try {
      ...
      if (_jspx_eval_c_005fif_005f6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("				    <div><input type='file' style='cursor: pointer; color:#4e73df;' name='file_\"+(fileIndex++)+\"'></input>\n");
          out.write("				    <button type='button' style='cursor: pointer; color:#4e73df;' id='fileDelBtn' class=\"btn btn-outline-error\">삭제</button></div>\n");
          out.write("				    </div>\n");
          out.write("\n");
          out.write("					\n");
          out.write("					<hr />\n");
  ...
  private boolean _jspx_meth_c_005fif_005f7(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/writeView.jsp(611,7) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
